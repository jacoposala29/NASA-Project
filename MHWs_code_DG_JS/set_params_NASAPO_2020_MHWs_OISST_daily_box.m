function params = set_params_NASAPO_2020_MHWs_OISST_DAILY_box(addpath_matlab_code,...
    num_gap_tsteps_in_event, years, tag_file,input_fname,fpath_oisst_daily_box,output_dir)
% addpath_matlab_code     = '/Users/dogi7244/Downloads/MHWs_code_DG/';
% num_gap_tsteps_in_event = 2;
% years                   = 1993:2016;
% tag_file                = '_avg_box_NEP';
% input_fname             = 'OISST_1993_2017';
% fpath_oisst_daily_box   = '/Users/dogi7244/Downloads/MHWs_data/OISST/';
...
% Tag file 
params.tag_file = tag_file; % DG9Aug '_avg_box_NEP'; % _avg_box_TASMAN _avg_box_NEP _avg_box_SWP
...
params.flag_noaa_oisst_daily_box = true;
...
params.zlev = [];
% File name
params.fname = input_fname; % DG9Aug 'OISST_1993_2017';
% Case tag
params.case_tag = 'oisst_v2';
% User path for OISST data
params.fpath_oisst_daily_box = fpath_oisst_daily_box; % DG9Aug '/Users/dogi7244/Downloads/MHWs_data/OISST/';
