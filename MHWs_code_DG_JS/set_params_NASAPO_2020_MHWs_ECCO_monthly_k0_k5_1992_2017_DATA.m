function params = set_params_NASAPO_2020_MHWs_ECCO_monthly_k0_k5_1992_2017_DATA(addpath_matlab_code,...
...
% Filename years
params.year_start_filename = 1992;
params.year_end_filename = 2017;
% Years ACTUALLY in the file
params.year_start_in_file = 1992;
params.year_end_in_file = 2017;
% ECCO data set name
