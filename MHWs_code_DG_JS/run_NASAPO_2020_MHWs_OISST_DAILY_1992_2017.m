...
params.addpath_matlab_code = '/Users/jacoposala/Downloads/';
% Tag for days between each event
params.num_gap_tsteps_in_event = 0; % 0, 2
% Set the range of years to analyze
params.years = 1992:1993;
% Tag file 
params.tag_file = '';
% Create the fig_path dynamically using the extracted years
params.fig_path = sprintf('/Users/jacoposala/Downloads/test_OISST_daily%s_%d_%d/', ...
...
params.zlev = [];
% File name
params.fname = 'sst.day.mean.';
% Case tag
params.case_tag = 'oisst_v2';
% User path for OISST data
params.fpath_oisst_daily = '/Users/jacoposala/Desktop/oisst_daily_input_files/';
